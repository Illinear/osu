...
namespace osu.Game.Rulesets.Osu.Difficulty
{
    public class OsuPerformanceCalculator : PerformanceCalculator
    {
        ...
        private double computeAccuracyValue(ScoreInfo score, OsuDifficultyAttributes attributes)
        {
            ...
            double accuracyValue = Math.Pow(1.52163, overallDifficulty) * Math.Pow(betterAccuracyPercentage, 24) * 0.00; // Was 2.83
        ...
        {
            // A simplified version of computeSpeedValue used as a placeholder for rhythm until more interesting things can be done
            ...
            rhythmValue *= Math.Pow(effectiveAccuracy, 2.0);
